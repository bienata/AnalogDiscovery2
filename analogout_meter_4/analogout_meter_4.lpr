...
(*
  plot 'data_50vpp.txt' with linespoints linestyle 1
  plot 'data_5vpp.txt' with linespoints linestyle 1
*)
...
begin
  ...
  FDwfAnalogInChannelRangeSet( hAd2, -1, 5.0 );   // zakres 50Vpp
  ...
  repeat
     ...
     SaveBuffToFile( @samplesBuff, MAX_SAMPLES, 'data.txt' );
